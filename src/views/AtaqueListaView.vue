                                ...
                                <button id="btn-editar" type="button" class="btn btn-outline-secondary"
                                    @click="editar(ataque.id)"> <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                        ...
                                        <path fill-rule="evenodd"
                                            ...
                                            0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 
                                ...
                                <button type="button" class="btn " data-bs-toggle="modal"
                                    ...
                                    ><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                        ...
                                        <path
                                            ...
                                            1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 
                                            .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" />
                                        <path fill-rule="evenodd"
                                            d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1
                                             0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0
                                              0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882
                                               4H4.118zM2.5 3V2h11v1h-11z" />
                                    </svg></button>

                                <div class="modal fade" id="confirmacaoExclusao" 
                                  tabindex="-1"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="texto" id="exampleModalLabel" >VOCÊ ESTÁ APAGANDO UM ATAQUE</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body texto">
                                                Você está apagando um ataque!! <strong>{{ataqueSelecionado.nome}}</strong>Ainda quer continuar?
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary" @click="removerAtaqueSelecionado" data-bs-dismiss="modal">Apagar Ataque</button>
