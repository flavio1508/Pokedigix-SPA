        ...
        <table class="table table-dark">
            ...
            <tbody>
                <tr v-for="ataque in ataques" :key="ataque.id">
                    ...
                    <td>
                        <button type="button" class="btn btn-dark btn-outline-secondary" @click="editar(ataque.id)">
                    ...
                    <td>
                        <button type="button" class="btn btn-dark btn-outline-danger" @click="deletar(ataque.id)">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
