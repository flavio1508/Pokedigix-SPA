    ...
    methods: {
        ...
        salvar() {
            ...
            this.pokemonRequest.ataquesIds =
                (this.pokemonRequest.ataquesIds.map(ataque => ataque.id));
        ...
        selecionarAtaque() {
            if (this.ataqueSelecionados.length < 4) {
                this.ataqueSelecionados.push(this.ataqueSelecionado);
                this.ataqueSelecionados = [... new Set(this.ataqueSelecionados)];
            }
        },
        removerAtaque(indice){
            this.ataqueSelecionados.splice(indice,1);
        ...
        <form>
            ...
            <div class="row">
                ...
                <select id="ataque1" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example"
                    @change="selecionarAtaque" v-model="ataqueSelecionado">
            ...
            <div class="row">
                <div class="col-3" v-for="(ataque, indice) in ataqueSelecionados" :key="ataque.id">
